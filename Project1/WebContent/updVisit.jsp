...
String mm = arr[1];
try {
	pStatement=dbConnection.prepareStatement("SELECT INDUSTRY, TO_CHAR(VISIT_DATE,'DD/MM/YYYY') AS VISITDATE, PURPOSE FROM "+DNet.MPR_FabricationVisits+" WHERE TO_CHAR(VISIT_DATE,'DD/MM/YYYY') LIKE '___"+mm+"_"+year+"' AND F_CPERSNO=?");
	pStatement.setString(1,emp.persno);
