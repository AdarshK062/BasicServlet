...
<head>
    ...
    <title>Add Visits to Fabrication agencies</title>
		...
		<input type="hidden" value=<%=end %> id="end"/>
			...
			<table class="tab" style="width:100%;">
				<thead>
					<tr>
						<th width="8%">Sr. No.</th>
						<th width="28%">Name of Industry</th>
						<th width="18%">Visit Date</th>
                        <th width="28%">Purpose/ Outcome</th>
                        <th></th>
					</tr>
				</thead>
				<tbody id="dataTable">
            ...
            <br>
            <input type="hidden" value="add7" name="add7"/>
