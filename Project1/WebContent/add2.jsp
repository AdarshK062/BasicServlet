...
<head>
    ...
    <title>Add Research papers</title>
...
<script>
	function addRow(tableID) {  
        ...
        element1.setAttribute('name', 'title'+rowCount);
        cell1.appendChild(element1);
        
        var element2 = document.createElement("input");
        element2.type = "text";
        element2.setAttribute('required', '');
        element2.setAttribute('name', 'jour'+rowCount);
        ...
        element3.setAttribute('name', 'date'+rowCount);
        element3.setAttribute('min',start);
        element3.setAttribute('max',end);
            ...
            <form action="home.jsp" method="post">
                <table class="tab" style="width:100%;">
                    <thead>
                        <tr>
                            <th width="8%">Sr. No.</th>
                            <th width="28%">Title of Research Paper</th>
                            <th width="28%">Journal/ Conference name</th>
                            <th width="18%">Date</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody id="dataTable">
                        <tr>
                            ...
                            <td><input type="text" required value="" name="jour1"></td>
                            <td><input type="date" required value="" min=<%=start %> max=<%=end %> name="date1"></td>
