...
function updateForm(i){
	...
	document.getElementById('rnoL'+i).style.display="none";
	document.getElementById('rnoI'+i).style.display="block";
...
<div class="div-table" id="dataTable">
			<div class="div-table-row" id="head">
				...
				<div class="div-table-col-head"  style="width:25%">Report No.</div>
			...
			<form action="upd1.jsp" method="post">
				...
				<div class="div-table-col" style="width:25%">
					<p id="rnoL<%=i %>"><%=res.getString("REP_NO") %></p>
					<input type="text" required id="rnoI<%=i %>" style="display: none;" value='<%=res.getString("REP_NO") %>' name="reportNo">
				</div>
				<div class="div-table-col" style="width:15%">
					<p ><%=res.getString("REPD") %></p>
					<input type="hidden" style="display: none;"value='<%=res.getString("REPD") %>' name="reportDate">
				</div>
				<div class="div-table-col" style="width:25%">
				...
				<input type="hidden" value="<%=res.getString("REPD") %>" name="reportDate"/>
